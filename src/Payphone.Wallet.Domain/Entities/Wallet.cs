...
public sealed class Wallet
{
    ...
    public Wallet(DocumentId documentId, string name)
    {
    ...
    public Movement Debit(Money amount)
    {
        ...
        var movement = Movement.CreateDebit(Id, amount);
    ...
    public Movement Credit(Money amount)
    {
        ...
        var movement = Movement.CreateCredit(Id, amount);
        _movements.Add(movement);
        UpdatedAt = DateTime.UtcNow;
    ...
    {
        if (string.IsNullOrWhiteSpace(name))
            throw new WalletDomainException(DomainErrorCode.InvalidName, "Name cannot be empty.");
